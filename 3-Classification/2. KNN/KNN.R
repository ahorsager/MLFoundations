# KNN.R
# A template for a K Nearest Neighbor (KNN) model used for classification. 
# KNN models work just like they sound - they take a sample of data nearest
# the test sample (frequently 5 points) and use that to predict the
